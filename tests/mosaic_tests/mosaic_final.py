...
if reverse:
    original_image1 = cv2.flip(cv2.resize(cv2.imread("Images/photomosaic3.jpg"), (756, 900)), 1)
    image1 = original_image1.copy()

    original_image2 = cv2.flip(cv2.resize(cv2.imread("Images/photomosaic4.jpg"), (756, 900)), 1)
    image2 = original_image2.copy()
else:
    original_image1 = cv2.resize(cv2.imread("Images/photomosaic3.jpg"), (756, 900))
    image1 = original_image1.copy()

    original_image2 = cv2.resize(cv2.imread("Images/photomosaic4.jpg"), (756, 900))
    image2 = original_image2.copy()
